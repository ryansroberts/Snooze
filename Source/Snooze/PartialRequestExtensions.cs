...
namespace Snooze
{
    public static class PartialRequestExtensions
    {
        public static string PartialFor<TUrl, TEnum>(this HtmlHelper htmlHelper, IEnumerable<TEnum> items,
                                                     Func<TEnum, TUrl> f) where TUrl : Url
        {
        ...
        static RouteValueDictionary GetRouteValues<TUrl>(Type controllerType, TUrl url)
        {
            ...
            routeValues.Add("snooze_partial", true);
