...
{
    [Subject(typeof(Url))]
    public class When_converting_a_url_to_a_string_with_a_request_context : UrlSpec
    {
    ...
    [Subject(typeof(Url))]
    public class When_converting_a_url_to_a_string_without_a_request_context : UrlSpec
    {
        Because of = () => url = new CustomerUrl { Id = 1 };
    ...
    public class When_converting_a_suburl_to_a_string_with_a_request_context : UrlSpec
    {
    ...
    [Subject(typeof(SubUrl<>))]
    public class When_converting_a_suburl_to_a_string_with_no_request_context : UrlSpec
    {
        Because of = () => url = new OrderUrl { Parent = new CustomerUrl { Id = 1 }, OrderId = 2 };
    ...
    public class When_concatenating_a_url : UrlSpec
    {
    ...
    [Subject(typeof(Url))]
    public class When_using_a_wildcard_url : UrlSpec
    {
