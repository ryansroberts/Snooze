...
namespace Snooze.MSpec
{
	public class DynamicViewDataDictionary : DynamicObject
	{
		...
		public DynamicViewDataDictionary(ViewDataDictionary viewDataThunk) { _viewDataThunk = () => viewDataThunk; }
	...
	public abstract class TestSparkView : SparkViewBase, IViewDataContainer, ITextWriterContainer, IView
		{
